            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-5 me-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_2">Produk Hukum</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_3">Matriks</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                <li><a class="dropdown-item" href="contact.html"><i
                                            class="bi bi-layout-text-sidebar-reverse"></i> My Dashboard</a></li>
                                <li><a class="dropdown-item" href="contact.html"><i class="bi bi-box-arrow-right"></i>
                                        Logout</a></li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    ...
                    <ul class="site-footer-links">
                        ...
                        <li class="site-footer-link-item">
                            <a href="#" class="site-footer-link">Produk Hukum</a>
                        </li>

                        <li class="site-footer-link-item">
                            <a href="#" class="site-footer-link">Matriks</a>
                        </li>
                    </ul>
                </div>
