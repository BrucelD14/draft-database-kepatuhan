...
@section('container')
    ...
    <a href="/dashboard/peraturan_internal" class="btn btn-outline-secondary btn-sm"><i
            class="bi bi-arrow-left-circle-fill"></i> Kembali</a>
    <a href="/dashboard/peraturan_internal/{{ $internalReg->id }}/edit" class="btn btn-warning btn-sm"><i
            class="bi bi-pencil-fill"></i> Edit</a>
    <form action="/dashboard/peraturan_internal/{{ $internalReg->id }}" method="post" class="d-inline">
        @method('delete')
        @csrf
