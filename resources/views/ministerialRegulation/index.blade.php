                ...
                <div class="col-lg-8 col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="/{{ $active }}">{{ $title }}</a></li>
                        </ol>
                    </nav>
        ...
        <div class="container">
            <form method="get" class="custom-form pt-2 mb-lg-0 mb-5" role="search">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-8">
                        <div class="col-lg-6 col-12 mx-1">
                ...
                <div class="row justify-content-center pt-2">
                    <div class="col-lg-4 text-center">
                        <a href="/produk_hukum" class="btn btn-secondary me-3"><i class="bi bi-arrow-90deg-left"></i>
                            Kembali</a>
                        <a href="/peraturan_menteri_bumn" class="btn btn-warning"><i class="bi bi-arrow-clockwise"></i>
                            Refresh</a>
                    </div>
                </div>
            @endif
